...
const menuItems: MenuItem[] = [
  ...
  { id: 'item-4', name: 'Beef Tehari', price: 220, image: '🍲', restaurant: 'FoodExpress Kitchen' },
  { id: 'item-5', name: 'Chicken Roll', price: 120, image: '🌯', restaurant: 'FoodExpress Kitchen' },
];

export default function Cart() {
  const { items, addToCart, updateQuantity, removeFromCart, subtotal } = useCart();
