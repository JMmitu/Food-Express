...
export function Footer() {
  ...
  const handleSubscribe = () => {
    ...
    showToast("Subscribed! Check your inbox for weekly offers.");
    setEmail("");
  };
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex w-full sm:w-auto gap-0 bg-white rounded-2xl overflow-hidden shadow-lg min-w-[320px]">
              ...
              <button
                ...
                className="bg-[#111827] hover:bg-[#1f2937] transition text-white font-bold px-5 py-3 flex items-center gap-1.5 whitespace-nowrap"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-14 pb-8">
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-5 mb-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-3">
            <button
              onClick={() => showToast("The iOS app is coming soon — stay tuned!", "info")}
              className="flex items-center gap-2 bg-white/10 hover:bg-white/20 transition border border-white/10 rounded-xl px-4 py-2.5"
            >
            ...
            <button
              onClick={() => showToast("The Android app is coming soon — stay tuned!", "info")}
              className="flex items-center gap-2 bg-white/10 hover:bg-white/20 transition border border-white/10 rounded-xl px-4 py-2.5"
            >
              <span className="text-xl">🤖</span>
              <span>
